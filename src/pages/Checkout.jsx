  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      try {
        ...
        toast('Order saved! Shipping will be arranged soon.', { icon: '⚠️' })
      }
  ...
  if (orderDone) return (
    <div className="max-w-lg mx-auto px-4 py-16 text-center">
      ...
      <div className="flex flex-col gap-3">
        ...
        <a href={`https://wa.me/918469015674?text=Hi%20Shionix!%20Order%20%23${orderDone.id}`} target="_blank" rel="noopener noreferrer" className="btn w-full justify-center py-3.5 bg-[#25D366] hover:bg-[#20bd5a] text-white">Track on WhatsApp</a>
      </div>
    </div>
  )
