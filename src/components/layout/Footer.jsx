        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div>
            <Link to="/" className="inline-block mb-4">
              <span className="font-display font-black text-2xl">Shio<span className="text-brand-500">nix</span></span>
            </Link>
            ...
            <div className="flex gap-3">
              ...
              <a href="#" aria-label="YouTube"
                className="w-9 h-9 rounded-xl border border-[var(--border)] flex items-center justify-center text-[var(--text3)] hover:text-red-500 hover:border-red-500 transition-all">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <a href={`mailto:${email}`} className="text-sm text-[var(--text3)] hover:text-brand-500">{email}</a>
              </li>
              <li className="flex items-start gap-3">
                <Phone size={15} className="text-brand-500 mt-0.5 flex-shrink-0"/>
                <a href={`https://wa.me/${whatsapp}`} target="_blank" rel="noopener noreferrer" className="text-sm text-[var(--text3)] hover:text-brand-500">{phone}</a>
              </li>
              <li className="flex items-start gap-3">
